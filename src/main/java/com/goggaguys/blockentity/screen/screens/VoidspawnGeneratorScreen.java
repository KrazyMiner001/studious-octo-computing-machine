package com.goggaguys.blockentity.screen.screens;
...
public class VoidspawnGeneratorScreen extends HandledScreen<VoidspawnGeneratorScreenHandler> {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(new Identifier(OctoComputing.MOD_ID, "aaaa.png"), x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
